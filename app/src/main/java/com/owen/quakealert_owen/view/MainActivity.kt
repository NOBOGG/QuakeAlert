            ...
            viewModel.deleteComment(commentID).enqueue(object : retrofit2.Callback<SubmitComment>{
                override fun onResponse(
                    ...
                    if (response.isSuccessful){
                        Toast.makeText(this@MainActivity, "Comment Deleted", Toast.LENGTH_SHORT).show()
                    }else{
                        Toast.makeText(this@MainActivity, "Comment Delete Failed", Toast.LENGTH_SHORT).show()
                    }
                }
